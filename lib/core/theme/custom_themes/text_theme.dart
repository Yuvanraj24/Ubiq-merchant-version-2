...
class SiajTextTheme {
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    labelLarge: const TextStyle().copyWith(fontSize: 13.5,fontWeight: FontWeight.normal, color: Colors.black),
    labelMedium: const TextStyle().copyWith(fontSize: 12.8,fontWeight: FontWeight.normal, color: Colors.black),
  ...
  static TextTheme darkTextTheme = TextTheme(
    ...
    labelLarge: const TextStyle().copyWith(fontSize: 13.5,fontWeight: FontWeight.normal, color: Colors.white),
    labelMedium: const TextStyle().copyWith(fontSize: 12.8,fontWeight: FontWeight.normal, color: Colors.white),
