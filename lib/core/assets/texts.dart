class AppTextStrings {
  ...
  static const String firstName = "$enterText first Name";
  static const String lastName = "$enterText last Name";
  static const String email = "$enterText your e-Mail";
  static const String password = "$enterText your password";
  static const String confirmPassword = "Confirm your password";
  static const String newPassword = "$enterText new password";
  static const String username = "Username";
  static const String phoneNo = "$enterText your phone";
